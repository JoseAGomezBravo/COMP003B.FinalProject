...
namespace COMP003B.FinalProject.Controllers
{
    public class DistributorsController : Controller
    {
        ...
        public DistributorsController(BookSellerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DistributorID,DistributorName,DistributorDescription")] Distributor distributor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DistributorID,DistributorName,DistributorDescription")] Distributor distributor)
        {
