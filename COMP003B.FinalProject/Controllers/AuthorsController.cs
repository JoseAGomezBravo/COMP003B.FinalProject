...
namespace COMP003B.FinalProject.Controllers
{
    public class AuthorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AuthorId,PublisherId,PublisherName")] Author author)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AuthorId,PublisherId,PublisherName")] Author author)
        {
