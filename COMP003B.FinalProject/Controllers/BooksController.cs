...
namespace COMP003B.FinalProject.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BookId,AuthorId,Title,Language,Description")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BookId,AuthorId,Title,Language,Description")] Book book)
        {
            if (id != book.BookId)
            {
                return NotFound();
